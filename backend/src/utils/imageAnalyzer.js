...
export async function analyzeImage(imageBuffer, dictOfVars){
    ...
    const prompt = `
                ...
                Make sure to use extra escape characters like \\f -> \\\\f, \\n -> \\\\n, etc.
                ...
                PROPERLY QUOTE THE KEYS AND VALUES IN THE OBJECT FOR EASIER PARSING WITH JavaScript's JSON.parse.
        `;
        ...
        try {
            ...
            if (text.startsWith("```")) {
                // Remove leading ``` or ```json and the trailing ```
            ...
            try {
                ...
                console.error(`Error parsing the Gemini response: ${error}`);
            }
